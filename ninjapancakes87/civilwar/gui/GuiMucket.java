...
public class GuiMucket extends GuiContainer
{
    private static final ResourceLocation furnaceGuiTextures = new ResourceLocation("textures/gui/container/furnace.png");
    private TileEntityMucket tileFurnace;
    private static final String __OBFID = "CL_00000758";

    public GuiMucket(InventoryPlayer par1InventoryPlayer, TileEntityMucket par2TileEntityFurnace)
    {
        super(new ContainerMucket(par1InventoryPlayer, par2TileEntityFurnace));
