...
{
	private static final ResourceLocation texture = new ResourceLocation(Strings.MUSKETBALL_AMMO);
	...
	protected ResourceLocation getArrowTextures(EntityMusketBall par1EntityArrow)
    {
        return texture;
    }
	@Override
	protected ResourceLocation getEntityTexture(Entity entity) {
		return this.getArrowTextures((EntityMusketBall)entity);
	}	
}
