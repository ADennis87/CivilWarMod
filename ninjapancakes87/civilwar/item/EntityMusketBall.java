...
public class EntityMusketBall extends Entity implements IProjectile
{
    ...
    public EntityMusketBall(World par1World, EntityLivingBase par2EntityLiving, EntityLivingBase par3EntityLiving, float par4, float par5)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
    ...
    public EntityMusketBall(World par1World, EntityLivingBase par2EntityLiving, float par3)
    {
        super(par1World);
        this.renderDistanceWeight = 10.0D;
        this.shootingEntity = par2EntityLiving;
    ...
    public String getSoundEffect(int rand){
    	
    	switch(rand){
    	case 0: sound.equals("Civil War.thud");
    	case 1: sound.equals("Civil War.thump");
    	default: sound.equals("Civil War.thud");
    	}
    	return sound;
    }
        ...
        else
        {
            ...
            if (movingobjectposition != null)
            {
                if (movingobjectposition.entityHit != null)
                {
                    ...
                    {
                        damagesource = DamageSources.causeShotDamage(this, this.shootingEntity);
                    }
    ...
    public void onCollideWithPlayer(EntityPlayer par1EntityPlayer)
    {
        if (!this.worldObj.isRemote && this.inGround && this.arrowShake <= 0)
        {
            ...
            if (this.canBePickedUp == 1 && !par1EntityPlayer.inventory.addItemStackToInventory(new ItemStack(Registry.musketball, 1)))
            {
                flag = false;
            }
