...
public class ItemMusket extends Item{
    ...
    public void onPlayerStoppedUsing(ItemStack par1ItemStack, World par2World, EntityPlayer par3EntityPlayer, int par4)
    {
        ...
        if (flag || par3EntityPlayer.inventory.hasItem(Registry.musketball))
        {
            ...
            EntityMusketBall entityarrow = new EntityMusketBall(par2World, par3EntityPlayer, f * 2.0F);
            ...
            par2World.playSoundAtEntity(par3EntityPlayer, "Civil War:gunshot", 1.0F, 1.0F / (itemRand.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
