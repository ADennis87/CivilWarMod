...
public class SoldierRegistry
{
    ...
    protected Multimap<Integer, IVillageTradeHandler> tradeHandlers = ArrayListMultimap.create();
    protected Map<Class<?>, IVillageCreationHandler> villageCreationHandlers = Maps.newHashMap();
    protected Map<Integer, String> newVillagers = Maps.newHashMap();
    protected List<Integer> newVillagerIds = Lists.newArrayList();
    ...
    public static void applyRandomTrade(EntitySoldier_Union villager, Random rand)
    {
    ...
    public static void applyRandomTrade2(EntitySoldier_Rebel villager, Random rand)
    {
        int extra = instance().newVillagerIds.size();
        int trade = rand.nextInt(5 + extra);
        villager.setProfession(trade < 5 ? trade : instance().newVillagerIds.get(trade - 5));
